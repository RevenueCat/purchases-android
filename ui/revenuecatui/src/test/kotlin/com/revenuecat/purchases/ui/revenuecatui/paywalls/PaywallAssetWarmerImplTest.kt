...
internal class PaywallAssetWarmerImplTest {
    ...
    // Guards the META-INF/services descriptor against the impl being moved or renamed. Core discovers this
    // class only through that file, so nothing else in the build would fail.
    @Test

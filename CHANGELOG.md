## 10.22.0-alpha.01
## RevenueCat SDK
### Checkpoints Internal Alpha
This release includes experimental APIs for Checkpoints, a new API to integrate with RC. This release is meant for internal users only.

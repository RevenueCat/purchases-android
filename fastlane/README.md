...
### android build_google_mobile_ads_integration_sample

```sh
[bundle exec] fastlane android build_google_mobile_ads_integration_sample
```

Builds a Google Mobile Ads Integration Sample APK

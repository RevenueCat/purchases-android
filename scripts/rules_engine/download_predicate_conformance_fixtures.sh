...
# RevenueCat/khepri main. Invoked by the rules engine conformance CI job (or
# locally) before running the conformance suite.
#
...
OUTPUT_PATH="${KHEPRI_PREDICATE_CONFORMANCE_FIXTURE_PATH:-${REPO_ROOT}/rules-engine-internal/src/test/resources/predicate-conformance/predicate_conformance_v1.json}"

...
class OfflineCustomerInfoCalculator(
    ...
    /**
     * This will compute the customer info using Google Play's historical and active purchases only.
     * We will error out if there are any active inapp purchases. This is because we
     * 1) Don't have the purchase token generated by the backend

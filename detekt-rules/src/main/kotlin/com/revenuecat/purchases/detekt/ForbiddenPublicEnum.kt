...
class ForbiddenPublicEnum(config: Config) : Rule(config) {
    ...
    override val issue = Issue(
        ...
        description = "Public enum classes are bad for binary compatibility. " +
            "Adding a new entry breaks exhaustive when expressions in consumers. " +
            "Use abstract class + internal constructor + @JvmField companion constants instead. " +

...
final class PurchasesAPI {
    static void check(final Purchases purchases,
        ...
        purchases.purchaseSubscriptionOption(activity, storeProduct, subscriptionOption, upgradeInfo, purchaseChangeListener);
        purchases.purchaseSubscriptionOption(activity, storeProduct, subscriptionOption, makePurchaseListener);

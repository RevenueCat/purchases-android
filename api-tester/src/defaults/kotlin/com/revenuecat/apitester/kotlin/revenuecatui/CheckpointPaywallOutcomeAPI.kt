...
private class CheckpointPaywallOutcomeAPI {
    ...
    fun check(outcome: CheckpointPaywallOutcome, customerInfo: CustomerInfo, error: PurchasesError) {
        when (outcome) {
        ...
        val purchased: CheckpointPaywallOutcome = CheckpointPaywallOutcome.Purchased(customerInfo)

...
object BillingStrings {
    ...
    const val BILLING_WRAPPER_PURCHASES_ERROR = "GoogleBilling purchases failed to update: %s"
    const val BILLING_WRAPPER_PURCHASES_UPDATED = "GoogleBilling purchases updated: %s"

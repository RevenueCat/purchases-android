...
object RestoreStrings {
    ...
    const val QUERYING_PURCHASE_WITH_HASH = "[QueryPurchases] Purchase of type %s with hash %s"
    const val QUERYING_PURCHASE_WITH_TYPE = "[QueryPurchases] Querying Purchase with %s and type %s"

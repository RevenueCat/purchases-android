...
object AttributionStrings {
    ...
    const val ATTRIBUTES_SYNC_SUCCESS = Emojis.HEART_CAT_EYES + " Subscriber attributes synced successfully for App User ID: %s"
    ...
    const val DELETE_ATTRIBUTES_OTHER_USERS = Emojis.INFO + " Deleting old synced subscriber attributes that don't belong to %s"
    const val INVALID_SUBSCRIBER_ATTRIBUTES = Emojis.SAD_CAT_EYES + Emojis.ERROR + " One or more of the attributes sent could not be saved."
    const val MARK_ATTRIBUTES_SYNC_SUCCESS = Emojis.INFO + " Marking the following attributes as synced for App User ID: %s"
    ...
    const val SYNCING_ATTRIBUTES_ERROR = Emojis.SAD_CAT_EYES + Emojis.ERROR + " Error when syncing subscriber attributes. App User ID: %s, Error: %s"

...
object PurchaserInfoStrings {
    ...
    const val PURCHASERINFO_STALE_FOREGROUND = Emojis.INFO + " PurchaserInfo cache is stale, updating from network in foreground"
    const val STALE_CACHE_BACKGROUND = Emojis.INFO + " PurchaserInfo cache is stale, updating from network in background."

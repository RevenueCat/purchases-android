...
internal class QueryProductDetailsUseCase(
    ...
    private fun queryProductDetailsAsyncEnsuringOneResponse(
        ...
        listener: (BillingResult, List<ProductDetails>) -> Unit,
    ) {
        ...
        billingClient.queryProductDetailsAsync(params) { billingResult, queryProductDetailsResult ->
            ...
            queryProductDetailsResult.unfetchedProductList.takeUnless { it.isEmpty() }?.forEach {
                log(LogIntent.INFO) {
            ...
            listener(billingResult, queryProductDetailsResult.productDetailsList)
        }
    }

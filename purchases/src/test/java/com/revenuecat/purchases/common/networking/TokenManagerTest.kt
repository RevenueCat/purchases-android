 ...
 * headers (IAM phase 3, steps 7-9). These go through the real `derivePassword -> EncryptedItemStorage.create`
 * chain -- a real [Application] context, a real API key, no test doubles for storage -- since this step's
 * whole purpose is to own that chain correctly.
 */

...
class Purchases internal constructor(
    ...
    /**
     * This method will send active subscriptions and unconsumed in-app purchases to the RevenueCat backend.
     ...
     *
     * Note: For Amazon, this method will also send expired subscriptions and consumed in-apps to RevenueCat.
     *
     ...
     * This method will post all active subscriptions and non consumed in-apps associated with the current Play Store
     * account to RevenueCat and become associated with the current `appUserID`. If the receipt token is being

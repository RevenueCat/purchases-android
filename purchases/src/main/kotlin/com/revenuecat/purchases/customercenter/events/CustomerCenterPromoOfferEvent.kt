 ...
 *
 * This event tracks the lifecycle of promotional offers including successful purchases,
 * cancellations, rejections, and errors.
 *
...
class CustomerCenterPromoOfferEvent(
     ...
     *
     * @property type The type of promo offer event (success, cancel, rejected, error).
     ...
     * @property internalPromoOfferID The internal identifier for the promotional offer.
     * @property storePromoOfferID The store-specific identifier for the promotional offer.
    ...
    class Data(
        ...
        val internalPromoOfferID: String,
        val storePromoOfferID: String,

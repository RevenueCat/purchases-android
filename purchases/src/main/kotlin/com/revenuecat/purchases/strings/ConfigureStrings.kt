...
internal object ConfigureStrings {
    ...
    const val TEST_STORE_API_KEY = "Using a Test Store API key.\n" +
        "The Test Store is for development only. Never use a Test Store API key in production. Our SDK will crash if " +
        "using it in production. Test Store purchases are simulated, do not use Google Play or Amazon store, " +
        "and generate no revenue. Apps submitted with a Test Store API key will be rejected during App Review."

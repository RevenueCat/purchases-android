...
public object PurchaseStrings {
    ...
    public const val ACKNOWLEDGING_PURCHASE_ERROR: String = "Error acknowledging purchase. Will retry next queryPurchases. %s"
    public const val ACKNOWLEDGING_PURCHASE_ERROR_RESTORE: String = "Couldn't acknowledge purchase after restoring it, this most " +
    ...
    public const val CONSUMING_PURCHASE_ERROR_RESTORE: String = "Couldn't consume purchase after restoring it, this most likely " +
        "means the product has already been consumed."
    public const val NOT_CONSUMING_IN_APP_PURCHASE_ACCORDING_TO_BACKEND: String = "Not consuming in-app purchase according to" +
    ...
    public const val SYNCING_PURCHASE_ERROR_DETAILS_USER_ID: String = "Error syncing purchase %s for store user ID %s. Error: %s"
    ...
    public const val UPGRADING_INVALID_TYPE: String = "UpgradeInfo passed to purchase for non-sub product type. No upgrade will " +
    ...
    public const val INVALID_CALLBACK_TYPE_INTERNAL_ERROR: String = "Internal SDK error -- invalid callback type passed to " +
        "startProductChange."
    public const val ENTITLEMENT_EXPIRED_OUTSIDE_GRACE_PERIOD: String = "Entitlement %s is no longer active (expired %s) " +
        "and it's outside grace period window (last updated %s)"
    public const val EXTRA_CONNECTION_CANMAKEPAYMENTS: String = "BillingClient has returned more than once when checking if " +
        "device can make payments with result: %s."
    public const val EXTRA_CALLBACK_CANMAKEPAYMENTS: String = "Callback has already been called when checking if device can " +
        "make payments."
    public const val EXCEPTION_CANMAKEPAYMENTS: String = "Exception received when checking if device can make payments: \n%s."
    public const val EMPTY_ADD_ONS_LIST_PASSED: String = "An empty list of add-ons was provided. Will proceed with purchasing the " +
        "base product."
    public const val PURCHASING_ADD_ONS_ONLY_SUPPORTED_ON_PLAY_STORE: String = "Making a purchase with add-ons is only supported on" +
        " the Play Store."
    public const val DEFERRED_PRODUCT_CHANGE_WITH_BASE_PLAN_ID: String = "Passing a basePlanId in oldProductId (%s) during a " +

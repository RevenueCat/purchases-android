...
public class PaywallAnimation(
    @get:JvmSynthetic public val type: AnimationType,
    @get:JvmSynthetic @SerialName("ms_delay") public val msDelay: Int,
    @get:JvmSynthetic @SerialName("ms_duration") public val msDuration: Int,
) {

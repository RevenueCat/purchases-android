...
@JvmSynthetic
public const val NO_CORE_LIBRARY_DESUGARING_ERROR_MESSAGE: String = "Error building BillingFlowParams which is " +
    "required to perform purchases in the Play store. This is due to an issue in Google's Billing Client library. " +

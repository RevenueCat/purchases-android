 ...
 * read — or downloaded on demand and deduped — by that manager. Prefetch is no longer driven from here either:
 * the `workflows` topic handler prefetches as part of the sync, so offerings no longer gate on a workflows-list
 * fetch.
 *

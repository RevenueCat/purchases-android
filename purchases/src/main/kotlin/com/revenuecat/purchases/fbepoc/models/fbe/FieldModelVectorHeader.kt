...
// Fast Binary Encoding Header vector field model
internal class FieldModelVectorHeader(buffer: com.revenuecat.purchases.fbepoc.fbe.Buffer, offset: Long) : com.revenuecat.purchases.fbepoc.fbe.FieldModel(buffer, offset)
{
    private val _model = FieldModelHeader(buffer, offset)
    ...
    fun getItem(index: Long): FieldModelHeader
    {
    ...
    fun resize(size: Long): FieldModelHeader
    {
    ...
    operator fun get(values: java.util.ArrayList<com.revenuecat.purchases.fbepoc.models.Header>)
    {
        values.clear()
    ...
    operator fun get(values: java.util.LinkedList<com.revenuecat.purchases.fbepoc.models.Header>)
    {
        values.clear()
    ...
    operator fun get(values: java.util.HashSet<com.revenuecat.purchases.fbepoc.models.Header>)
    {
        values.clear()
    ...
    fun set(values: java.util.ArrayList<com.revenuecat.purchases.fbepoc.models.Header>)
    {
        assert((_buffer.offset + fbeOffset + fbeSize) <= _buffer.size) { "Model is broken!" }
        if ((_buffer.offset + fbeOffset + fbeSize) > _buffer.size)
            return
    ...
    fun set(values: java.util.LinkedList<com.revenuecat.purchases.fbepoc.models.Header>)
    {
        assert((_buffer.offset + fbeOffset + fbeSize) <= _buffer.size) { "Model is broken!" }
        if ((_buffer.offset + fbeOffset + fbeSize) > _buffer.size)
            return
    ...
    fun set(values: java.util.HashSet<com.revenuecat.purchases.fbepoc.models.Header>)
    {
        assert((_buffer.offset + fbeOffset + fbeSize) <= _buffer.size) { "Model is broken!" }
        if ((_buffer.offset + fbeOffset + fbeSize) > _buffer.size)
            return

...
// Fast Binary Encoding Bytes->Bytes map field model
internal class FieldModelMapBytesBytes(buffer: com.revenuecat.purchases.fbepoc.fbe.Buffer, offset: Long) : com.revenuecat.purchases.fbepoc.fbe.FieldModel(buffer, offset)
{
    private val _modelKey = com.revenuecat.purchases.fbepoc.fbe.FieldModelBytes(buffer, offset)
    private val _modelValue = com.revenuecat.purchases.fbepoc.fbe.FieldModelBytes(buffer, offset)
    ...
    // Map index operator
    fun getItem(index: Long): Pair<com.revenuecat.purchases.fbepoc.fbe.FieldModelBytes, com.revenuecat.purchases.fbepoc.fbe.FieldModelBytes>
    {
    ...
    fun resize(size: Long): Pair<com.revenuecat.purchases.fbepoc.fbe.FieldModelBytes, com.revenuecat.purchases.fbepoc.fbe.FieldModelBytes>
    {
    ...
    fun get(values: java.util.TreeMap<ByteArray, ByteArray>)
    {
        values.clear()
    ...
    fun get(values: java.util.HashMap<ByteArray, ByteArray>)
    {
        values.clear()
    ...
    fun set(values: java.util.TreeMap<ByteArray, ByteArray>)
    {
        assert((_buffer.offset + fbeOffset + fbeSize) <= _buffer.size) { "Model is broken!" }
        if ((_buffer.offset + fbeOffset + fbeSize) > _buffer.size)
            return
    ...
    fun set(values: java.util.HashMap<ByteArray, ByteArray>)
    {
        assert((_buffer.offset + fbeOffset + fbeSize) <= _buffer.size) { "Model is broken!" }
        if ((_buffer.offset + fbeOffset + fbeSize) > _buffer.size)
            return

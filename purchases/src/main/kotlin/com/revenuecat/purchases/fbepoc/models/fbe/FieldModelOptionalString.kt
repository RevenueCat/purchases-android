...
internal class FieldModelOptionalString(buffer: com.revenuecat.purchases.fbepoc.fbe.Buffer, offset: Long) : com.revenuecat.purchases.fbepoc.fbe.FieldModel(buffer, offset)
{
    // Field size
    ...
    val value = com.revenuecat.purchases.fbepoc.fbe.FieldModelString(buffer, 0)
    ...
    fun get(defaults: String? = null): String?
    {

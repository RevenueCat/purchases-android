...
class RulesEngineEvaluateTest {
    ...
    fun `malformed JSON yields parse failure`() {
        ...
        assertThat(result.exceptionOrNull()).isInstanceOf(RuleError.Parse::class.java)
    }
    ...
    fun `unsupported operator yields failure`() {
        ...
        assertThat(result.isFailure).isTrue()
        assertThat(result.exceptionOrNull()).isInstanceOf(RuleError.UnsupportedOperator::class.java)
    }
}

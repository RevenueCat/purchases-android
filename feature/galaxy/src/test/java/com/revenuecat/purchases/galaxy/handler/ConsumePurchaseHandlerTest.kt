...
class ConsumePurchaseHandlerTest {
    ...
    fun `consumePurchase errors when Galaxy Store rejects request`() {
        ...
        assertThat(receivedError?.underlyingErrorMessage)
            .isEqualTo(GalaxyStrings.GALAXY_STORE_FAILED_TO_ACCEPT_CONSUME_REQUEST)
    ...
    @OptIn(GalaxySerialOperation::class)
    @Test
    fun `successful consume forwards result clears in flight request and sends purchase token`() {
        ...
        consumePurchaseHandler.onConsumePurchasedItems(successErrorVo, arrayListOf(consumptionResult))
    ...
    fun `successful consume with empty results forwards store problem error`() {
        ...
        assertThat(receivedError?.code).isEqualTo(PurchasesErrorCode.StoreProblemError)
        assertThat(receivedError?.underlyingErrorMessage)
            .isEqualTo(GalaxyStrings.CONSUME_REQUEST_RETURNED_SUCCESS_BUT_NO_CONSUMPTION_RESULTS)
    ...
    fun `successful consume with multiple results forwards store problem error`() {
        ...
        assertThat(receivedError?.code).isEqualTo(PurchasesErrorCode.StoreProblemError)
        assertThat(receivedError?.underlyingErrorMessage)
            .isEqualTo(GalaxyStrings.CONSUME_REQUEST_RETURNED_MORE_THAN_ONE_RESULT)
    }

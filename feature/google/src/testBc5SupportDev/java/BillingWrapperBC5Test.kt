...
class BillingWrapperBC5Test {
    ...
    fun defersCallingSkuQueryUntilConnected() {
        ...
        wrapper.querySkuDetailsAsync(
            ...
            productIDs,
            {
                this@BillingWrapperBC5Test.storeProducts = it
            }, {
    ...
    fun canDeferMultipleCalls() {
        ...
        wrapper.querySkuDetailsAsync(
            ...
            productIDs,
            {
                this@BillingWrapperBC5Test.skuDetailsResponseCalled += 1
            },
            {
                fail("shouldn't be an error")
            })
    ...
    fun purchasesUpdatedCallsAreForwarded() {
        ...
        setUpMockQueryPurchaseParamsBuilder(billingClientOKResult, purchases)
    ...
    fun `when querying anything and billing client returns an empty list, returns an empty list`() {
        setUpMockQueryPurchaseParamsBuilder(billingClientOKResult, listOf())
